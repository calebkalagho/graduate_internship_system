...
<script>
    function exportToPDF() {
        ...
        // AutoTable to create a table in PDF
        doc.autoTable({
            html: 'table', // Your table's selector
            theme: 'grid',
            headStyles: {
                fillColor: [0, 0, 0]
            ...
            bodyStyles: {
                textColor: [0, 0, 0]
            }, // Optional: style for body
            styles: {
                fontSize: 9
            }, // Optional: font size
        });

        doc.save('applicant_report.pdf'); // Save the PDF
    }
</script>

<script>
    function exportToExcel() {
        var table = document.querySelector("table"); // Select your table element
        var wb = XLSX.utils.table_to_book(table, {
            sheet: "Sales"
        }); // Convert table to workbook
        XLSX.writeFile(wb, "applicant_report.xlsx"); // Download the file
    }
</script>