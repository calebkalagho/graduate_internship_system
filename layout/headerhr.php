                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./graduates_list_hr.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./vacancies_list_hr.php" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./application_list_hr.php" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Review</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="./application_list_reviewed_hr.php" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Allocated</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./reports/applicants-report.html" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
