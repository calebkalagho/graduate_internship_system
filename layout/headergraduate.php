...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="./vacancies_list_graduate.php" class="nav-link">Vacancies</a> </li>

                </ul> <!--end::Start Navbar Links--> <!--begin::End Navbar Links-->
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->

                    <li> <a class="nav-link" href="./graduate_notification.php"> <i class="bi bi-chat-text"></i>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./graduate.php" class="brand-link"> <!--begin::Brand Image--> <img src="./dist/assets/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <span class="brand-text fw-light">Graduate MS</span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">

                        <li class="nav-item"> <a href="./graduate.php" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                                <p>Dashboard</p>
                            </a> </li>
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./application_graduate_new.php?user_id=<?= $user_id ?>" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>New</p>
                                    </a>
                                </li>
                                <li class="nav-item"> <a href="./application_graduate_list.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>All</p>
                                    </a> </li>
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="./single_intern_perfomance_report.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Reports</p>
                                    </a> </li>
